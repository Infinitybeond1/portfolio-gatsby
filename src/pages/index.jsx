...
import { Copyright, DiscordLogo, GithubLogo, NewspaperClipping, EnvelopeOpen, HeartStraight } from 'phosphor-react'
...
function Index() {
  return (
    <>
      ...
      <div class="footer">
        <p class="footer-txt">
          Made with <a href="https://github.com/Infinitybeond1/site" target="_blank" rel="noreferrer"><HeartStraight size={12} weight="fill" class="heart"/></a> using the <a href="https://github.com/articblush" target="_blank" rel="noreferrer">articblush</a> colorscheme and <a href="https://www.gatsbyjs.com/" target="_blank" rel="noreferrer">
      ...
      </a>  |  <a href="https://github.com/Infinitybeond1/site/blob/main/LICENSE" target="_blank" rel="noreferrer"><Copyright size={13} /> Luke 2022</a>
        </p>
      </div>
    </>
  );
